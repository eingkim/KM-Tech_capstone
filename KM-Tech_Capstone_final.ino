...
void frequencySweepEasy() {
    ...
    if (AD5933::frequencySweep(real, imag, NUM_INCR+1)) {
      ...
      Serial.print(":");
      Serial.println((sec%3600)%60);
      
      for(int j = 0; j<NUM_INCR+1; j++)
        average += ave[j];
      average /= NUM_INCR+1-count_inf;
      Serial.print("ave = ");
      Serial.println(average);
      Serial.print("# of inf: ");
      Serial.println(count_inf);
      Serial.println("Frequency sweep complete!(Easy)");
